...
<div class="top container-fluid mt-5">
  <div class="history-text text-white text-wrap w-100 d-flex justify-content-center
   <?= !empty($_SESSION['my_history'])? 'd-none' : ""; ?> ">
      <p> You haven't watched any movie.</p>
  </div>
